...
<head>
    ...
    <!-- Essential styles -->
    <link rel="stylesheet" href="/boomerang/assets/bootstrap/css/bootstrap.min.css" type="text/css">
    <link rel="stylesheet" href="/boomerang/font-awesome/css/font-awesome.min.css" type="text/css"> 
    <link rel="stylesheet" href="/boomerang/assets/fancybox/jquery.fancybox.css?v=2.1.5" media="screen"> 
     
    <!-- Boomerang styles -->
        <link id="wpStylesheet" type="text/css" href="/boomerang/css/global-style.css" rel="stylesheet" media="screen">
        

    <!-- Favicon -->
    <link href="/boomerang/images/favicon.png" rel="icon" type="image/png">

    <!-- Assets -->
    <link rel="stylesheet" href="/boomerang/assets/owl-carousel/owl.carousel.css">
    <link rel="stylesheet" href="/boomerang/assets/owl-carousel/owl.theme.css">
    <link rel="stylesheet" href="/boomerang/assets/sky-forms/css/sky-forms.css">    
    <!--[if lt IE 9]>
        <link rel="stylesheet" href="assets/sky-forms/css/sky-forms-ie8.css">
    <![endif]-->

    <!-- Required JS -->
    <script src="/boomerang/js/jquery.js"></script>
    <script src="/boomerang/js/jquery-ui.min.js"></script>

    <!-- Page scripts -->
    <link rel="stylesheet" href="/boomerang/assets/layerslider/css/layerslider.css" type="text/css">
    ...
    <div class="navbar navbar-wp navbar-arrow mega-nav" role="navigation">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="/" title="summit.ba">
                    <img src="/boomerang/images/header-logo.png" alt="summit.ba">
                </a>
            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-3 mega-nav-section-wr">
                                        <div class="mega-nav-section">
                                            <img src="/boomerang/images/prv/wk-big-img-9.jpg" class="img-responsive img-thumbnail hidden-xs hidden-sm" alt="">
                                    ...
                                    <div class="col-md-3 mega-nav-section-wr">
                                        <div class="mega-nav-section"> 
                                            <img src="/boomerang/images/prv/wk-big-img-10.jpg" class="img-responsive img-thumbnail hidden-xs hidden-sm hidden-xs hidden-sm" alt="">
                                    ...
                                    <div class="col-md-3 mega-nav-section-wr">
                                        <div class="mega-nav-section">
                                            <img src="/boomerang/images/prv/wk-big-img-11.jpg" class="img-responsive img-thumbnail hidden-xs hidden-sm" alt="">
                                    ...
                                    <div class="col-md-3">
                                        <div class="mega-nav-section">
                                            <img src="/boomerang/images/prv/wk-big-img-12.jpg" class="img-responsive img-thumbnail hidden-xs hidden-sm" alt="">
